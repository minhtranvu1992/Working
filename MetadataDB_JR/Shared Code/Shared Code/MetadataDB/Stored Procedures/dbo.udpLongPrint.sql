CREATE PROCEDURE [dbo].[udpLongPrint]( @string varchar(max) )
AS
SET NOCOUNT ON
...
declare @len int, @cr_index int, @lf_index int, @crlf_index int, @has_cr_and_lf bit, @left varchar(8000), @reverse varchar(8000)
set @len = 8000
