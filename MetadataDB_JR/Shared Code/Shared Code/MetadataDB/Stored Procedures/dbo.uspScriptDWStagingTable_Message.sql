...
-- ====================================================================================
CREATE PROCEDURE [dbo].[uspScriptDWStagingTable_Message]
...
SET ANSI_WARNINGS OFF
	...
	BEGIN TRY
	    ...
	    DECLARE @FeedProcessDel AS VARCHAR(MAX)
...
'
	   ...
	   SET @StagingJobIDDataType = 'UniqueIdentifier'
