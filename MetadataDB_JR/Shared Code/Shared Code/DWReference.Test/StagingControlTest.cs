...
namespace DWReference.Test
{
    ...
    public class StagingControlTest
    {
        ...
        public void GetFileSuites2()
        {
            ...
            DataHelper.RunQuery("DELETE FROM dbo.StagingControl", connStr);
            DataHelper.LoadExcelData(BulkPath, @"StagingControl\SimpleLoad2.xlsx", "Suite", "SuiteID", connStr, DataHelper.DataRecordHandling.Insert);
        ...
        public void GetFileSuites3()
        {
            ...
            DataHelper.RunQuery("DELETE FROM dbo.StagingControl", connStr);
            DataHelper.LoadExcelData(BulkPath, @"StagingControl\SimpleLoad3.xlsx", "Suite", "SuiteID", connStr, DataHelper.DataRecordHandling.Insert | DataHelper.DataRecordHandling.Update);
        ...
        public void TestspGetStagingManagerFolderLocation()
        {
            ...
            string FolderLocationUprocessed = Path.Combine(dr["BaseFolder"].ToString(),
                                                               ...
                                                               dr["Folder"].ToString());
            Assert.AreEqual(expected, FolderLocationUprocessed);
        }
        ...
        /// </summary>
        [TestMethod]
        public void SimpleLoadFileWithFailureLogging()
        {
            string connStr_DWRefenece = ConfigurationManager.ConnectionStrings["DWRefenece"].ConnectionString;
            string connStr_DWStaging = DataHelper.GetDataSSISConfiguration("ConnStr_DWStaging_DB", connStr_DWRefenece);
            string BulkPath = ConfigurationManager.AppSettings["DataFiles"];
            ...
            //checked file moved
            Assert.AreEqual(false, File.Exists(FileDestination));
            //check the package should failed and no data loaded
            result = DataHelper.GetCount("SELECT COUNT(*) FROM " + StagingTable, connStr_DWStaging);
            Assert.AreEqual(result, 0);

            //check file is in failed folder
            ...
            int count =
                DataHelper.GetCount(
                    "select count(*) from [DWReference].[dbo].[StagingExecutionLog] where SuccessFlag =0 and CompletedFlag =1 and StagingControlId= 1",
                    connStr_DWRefenece);
        ...
        public void CheckFileHeadersAndColumns1()
        {
            ...
            DataHelper.LoadExcelData(BulkPath, @"StagingControl\SimpleLoad1.xlsx", "Suite", "SuiteID", connStr_DWRefenece, DataHelper.DataRecordHandling.Insert | DataHelper.DataRecordHandling.Update);
            ...
            var result = sh.CheckFileHeadersAndColumns(FileDestination1, sourceQueryMapping, stagingTable, connStr_DWStaging, delimiter);
        ...
        public void CheckFileHeadersAndColumnsWithWrongSourceQueryMapping()
        {
            ...
            try
            {
                ...
                string connStr_DWStaging = DataHelper.GetDataSSISConfiguration("ConnStr_DWStaging_DB", connStr_DWRefenece);
                string BulkPath = ConfigurationManager.AppSettings["DataFiles"];
                DataHelper.LoadExcelData(BulkPath, @"StagingControl\SimpleLoad5.xlsx", "Suite", "SuiteID", connStr_DWRefenece, DataHelper.DataRecordHandling.Insert | DataHelper.DataRecordHandling.Update);
        ...
        public void TruncateStagingTable1()
        {
            ...
            DataHelper.LoadExcelData(BulkPath, @"StagingControl\SimpleLoad1.xlsx", "StagingControl", "StagingControlID", connStr_DWRefenece, DataHelper.DataRecordHandling.Insert | DataHelper.DataRecordHandling.Delete);
            DataHelper.RunQuery("UPDATE dbo.StagingControl SET TruncateStagingTable=1 where StagingControlID=1", connStr_DWRefenece);

            DataHelper.ExecuteSqlScript(Path.GetFullPath(Path.Combine(BulkPath, @"StagingControl\SimpleLoadQuery.sql")), connStr_DWRefenece);
            DataHelper.RunQuery("INSERT INTO [dbo].[STG_SimpleLoad](TestID, TestName, LoadTime, amount, isFlag, StagingJobID) VALUES(1,'Test1',getdate(),1,1,1)", connStr_DWStaging);
            ...
            Assert.AreEqual(dsStagingTable, 0);
        }
        ...
        public void DuplicateProcessControl()
        {
            ...
            string connStr_DWRefenece = ConfigurationManager.ConnectionStrings["DWRefenece"].ConnectionString;
            string BulkPath = ConfigurationManager.AppSettings["DataFiles"];
            DataHelper.LoadExcelData(BulkPath, @"StagingControl\StagingControl_DuplicateProcess.xlsx", "Suite", "SuiteID", connStr_DWRefenece, DataHelper.DataRecordHandling.Insert | DataHelper.DataRecordHandling.Update);
        ...
        public void EmailStagingMaxExpectedDurationBetweenFilesFailure()
        {
            ...
            DataHelper.LoadExcelData(BulkPath, @"StagingControl\StagingControl_MaxExpectedDurationFailure.xlsx", "Suite", "SuiteID", connStr_DWRefenece, DataHelper.DataRecordHandling.Insert | DataHelper.DataRecordHandling.Update);
        ...
        public void EmailStagingMaxExpectedDurationBetweenFilesSuccess()
        {
            ...
            DataHelper.LoadExcelData(BulkPath, @"StagingControl\StagingControl_MaxExpectedDurationSuccess.xlsx", "Suite", "SuiteID", connStr_DWRefenece, DataHelper.DataRecordHandling.Insert | DataHelper.DataRecordHandling.Update);
